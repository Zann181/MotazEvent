...
class AsistenteAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Consumos", {"fields": ("consumos_disponibles",)}),
        ("QR Code", {"fields": ("codigo_qr", "qr_image")}),
        ("Metadatos", {"fields": ("fecha_registro", "creado_por")}),
    )
...
admin.site.site_header = "Zann Event - Administración"
admin.site.site_title = "Zann Event Admin"
